...
/// <summary>
/// Pure ActualSpend aggregation rule (see CLAUDE.md > Business Rules > Budget goals, item 5),
...
{
    /// <summary>
    /// Sums the absolute amount of every transaction that counts toward ActualSpend for
